...
/// Logical left shift for u32 by `shift` bits (shift masked to 0..31).
#[inline]
...
/// Logical right shift for u32 by `shift` bits (zero-fill).
#[inline]
...
/// Rotate left for u32 by `rot` bits.
#[inline]
...
/// Rotate right for u32 by `rot` bits.
#[inline]
