...
/// Graphics subsystem errors.
    ...
    Window,
    /// Canvas / pixel buffer errors.
    Canvas,
    /// X11 backend errors.
    X11,
    /// Token/lexer errors.
    Lex,
    /// Scope / environment errors.
    Scope,
    /// Loop control errors.
    Loop,
    /// Threading errors.
...
fn format_kind(k: &ErrorKind) -> &'static str {
    match k {
        ...
        ErrorKind::Graphics      => "GraphicsError",
        ErrorKind::Window        => "WindowError",
        ErrorKind::Canvas        => "CanvasError",
        ErrorKind::X11           => "X11Error",
        ErrorKind::Lex           => "LexError",
        ErrorKind::Scope         => "ScopeError",
        ErrorKind::Loop          => "LoopError",
        ErrorKind::Thread        => "ThreadError",
        ErrorKind::Ai            => "AiError",
        ErrorKind::Tensor        => "TensorError",
