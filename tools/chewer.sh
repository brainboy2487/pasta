mkdir -p tools
cat > tools/chewer.py <<'PY'
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
tools/chewer.py
Preprocess artifacts/CHEWME.txt into a cleaned file and 25KB bite files:
  - artifacts/CHEWME_clean.txt
  - artifacts/EATMEBITE1.txt, EATMEBITE2.txt, ...
  - artifacts/CHEWME_summary.txt
  - artifacts/CHEWME_manifest.json
"""
...
ESC = chr(27)
ANSI_RE = re.compile(re.escape(ESC) + r'
